...
public class CalcMethodDeclarationKey{
	private final String name;
	private final String signature;

	public CalcMethodDeclarationKey(String name, String signature){
		this.name = name;
	...
	public boolean equals(Object o){
		...
		if(!(o instanceof CalcMethodDeclarationKey)) return false;
		CalcMethodDeclarationKey key = (CalcMethodDeclarationKey) o;
